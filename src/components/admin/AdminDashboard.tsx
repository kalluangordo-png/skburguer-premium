    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button 
          ...
          className="flex items-center gap-3 bg-white text-black px-8 py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest transition-all hover:bg-orange-500 hover:scale-105 active:scale-95"
        >
      ...
      <div className="glass p-10 rounded-[3rem]">
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="text-right">
            <span className="text-orange-500 font-black text-5xl italic leading-none">{(stats.progresso || 0).toFixed(0)}%</span>
          </div>
        </div>
        <div className="h-6 bg-black/60 rounded-full p-1.5 border border-white/5 overflow-hidden">
          <div 
            className="h-full rounded-full transition-all duration-1000 bg-gradient-to-r from-orange-600 to-yellow-400 shadow-[0_0_20px_rgba(249,115,22,0.4)]"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-orange-500 p-8 rounded-[3rem] text-black h-full flex flex-col relative overflow-hidden">
...
const StatCard = ({ title, value, icon: Icon, highlight }: any) => (
  <div className={`${highlight ? 'bg-orange-500 text-black' : 'glass text-white'} p-8 rounded-[2.5rem] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300`}>
